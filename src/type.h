...
public:
    static FuncType *
    New(QualType derived, int funcSpec, const ParamList &params, FunctionDecl *fd = nullptr);
    static FuncType *New(QualType derived, int funcSpec, FunctionDecl *fd = nullptr);
    virtual ~FuncType() {}
    virtual FuncType *ToFunc()
    {
        return this;
    ...
    virtual bool IsVoid() const
    {
        return (m_func_spec & F_NORETURN) || m_derived->IsVoid() || m_derived->ToVoid();
    }
    virtual bool IsChar() const
    {
